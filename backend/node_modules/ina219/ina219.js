...
Ina219.prototype.calibrate32V1A  = function (callback) {
	...
	this.currentDivider_mA = 25;      // Current LSB = 40uA per bit (1000/40 = 25)
  	this.powerDivider_mW = 1;         // Power LSB = 800µW per bit
...
/**
  * Gets the raw power values
	* @param {onHaveValueCallback} callback - Callback to be invoked when complete.
  */
Ina219.prototype.getPower_raw  = function (callback) {

    this.log("getPower_raw");
    var $this = this;
    this.readRegister(INA219_REG_POWER, function (value) {
